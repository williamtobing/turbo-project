  ...
  <footer className="bg-darkGunmetal">
    <div className="space-y-2 p-4">
      <p className="text-myWhite text-xs font-semibold">
        This website is a site that I developed myself for personal publication
        purposes. Thank you for visiting my website. May we all be well and
      ...
      <div className="flex justify-between">
        ...
        <div className="flex items-end space-x-2">
          <a
            ...
            rel="noreferrer"
          >
            <NeuBox variant="sm" className="border-portage shadow-neu-chalky-4">
